function create_box(x, y, w, h, type)
    ...
    self.w = w
    self.h = h
    self.body = love.physics.newBody(world, x - w / 2, y - h / 2, "dynamic") -- remember, the shape (the rectangle we create next) anchors to the body from its center, so we have to move it to (650/2, 650-50/2)
    ...
    self.fixture:setUserData(RandomString(32)) -- let the ball bounce
