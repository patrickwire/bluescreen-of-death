function create_container(x, y, w, h, type)
    ...
    container.w = w
    container.h = h
    container.body = love.physics.newBody(world, x, y, "dynamic") -- remember, the shape (the rectangle we create next) anchors to the body from its center, so we have to move it to (650/2, 650-50/2)
