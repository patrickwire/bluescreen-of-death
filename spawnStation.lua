function create_spawn(x, y, w, h, world)
    local self = {
        public_field = 0,
        touching = {}
    }
    local asset= love.graphics.newImage("assets/gfx/playerSpawnStation001.png")
    local position = {}
    position.x = x
    position.y = y
    position.x = x
